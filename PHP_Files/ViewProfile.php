...
// $result = mysqli_query($db, "SELECT * FROM rir_user WHERE id=".$id." LIMIT 1");
...
<div class="container">
    <section class="main-section contact" id="My_Profile">
        <div class="row">
                    <div class="form">
                        ...
                        <form class="contactForm" role="form" name="" action="" method="POST">
                            ...
                            <div class="form-group col-md-6">
                                <!-- <h2>IC Number : </h2> -->
                                <input class="form-control input-text" name="User_IC_Number" type="text" placeholder="IC Number" maxlength="14" size="" id="User_IC_Number" disabled="">
                                <br><br>
                            ...
                            <div class="form-group col-md-6">
                                <!-- <h2>Full Name :</h2> -->
                                <input class="form-control input-text" name="User_FullName" type="text" placeholder="Full Name" maxlength="50" size="" id="User_FullName" disabled="">
                                <br><br>
                                <div class="validation"></div>
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                <!-- <h2>Username : </h2> -->
                                <input class="form-control input-text" name="User_Name" type="text" placeholder="Username" maxlength="20" size="" id="User_Name" disabled="">
                                <br><br>
                                <div class="validation"></div>
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                <!-- <h2>Password : </h2> -->
                                <input class="form-control input-text" name="User_Password" type="text" placeholder="Password" size="" id="User_Password" disabled="">
                                <br><br>
                                <div class="validation"></div>
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                <!-- <h2>Birthdate : </h2> -->
                                <input class="form-control input-text" name="User_Birthdate" type="text" placeholder="Birthdate" maxlength="10" size="" id="User_Birthdate" disabled="">
                                <br><br>
                                <div class="validation"></div>
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                <!-- <h2>Email : </h2> -->
                                <input class="form-control input-text" name="User_Email" type="text" placeholder="Email" maxlength="50" size="" id="User_Email" disabled="">
                                <br><br> 
                                <div class="validation"></div>
                            </div>

                            <div class="text-center">
                                <button class="input-btn" name="Edit_Profile" type="submit"> Edit Profile</button>
                            </div> 
                        </form>
